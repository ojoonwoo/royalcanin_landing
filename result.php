...
<body>
    <div id="container">
        <div id="header">
            <div class="inner">
                <a href="./" class="logo" onclick="gtag('event', '홈버튼', {'event_category': '결과페이지', 'event_label': '메인로고'});">
                    <img src="./images/logo.png" alt="로얄캐닌 홈으로">
                </a>
                <nav class="menu">
                    <ul>
                        <li>
                            <a href="./#section1" onclick="gtag('event', 'GNB', {'event_category': '결과페이지', 'event_label': '메인'});">메인</a>
                        </li>
                        <li>
                            <a href="./#section2" onclick="gtag('event', 'GNB', {'event_category': '결과페이지', 'event_label': '주치의 프로젝트'});">주치의 프로젝트</a>
                        </li>
                        <li class="active">
                            <a href="./#section3" onclick="gtag('event', 'GNB', {'event_category': '결과페이지', 'event_label': '주치의력 테스트'});">주치의력 테스트</a>
                        </li>
                        <li>
                            <a href="./#section4" onclick="gtag('event', 'GNB', {'event_category': '결과페이지', 'event_label': '주치의력 업그레이드 TIPS'});">주치의력 업그레이드 TIPS</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        var adviceObject = {
            "single": {
                "msg": {
                    ...
                    "gastro": "소화기 문제를 일으킬 다양한 원인 행동을 보이고 있어요.<br>이러한 행동은 소화기 관련 문제를 유발시킬 원인이 될 수 있으니<br>정확한 진단을 위해서는 수의사 선생님과의 상담이 필요합니다.",
