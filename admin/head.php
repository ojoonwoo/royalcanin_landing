    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="entry_list.php">RoyalCanin</a>
        </div>
        <!-- Top Menu Items -->
            ...
            <ul class="nav navbar-nav side-nav">
              <li class="active">
                ...
                <ul id="demo" class="collapse">
                  ...
                  <li>
                    <a href="daily_media_count.php">일자별 참여자 수</a>
                  </li>
...
-->
                  ...
                  <li>
                    <a href="daily_report.php">일자별 버튼 클릭 리포트</a>
                  </li> -->
                </ul>
              </li>

              <li>
                <a href="entry_list.php"><i class="fa fa-fw fa-table"></i> 참여정보 리스트</a>
              </li>
              <!-- <li>
                <a href="data_list.php"><i class="fa fa-fw fa-table"></i> 등록된 데이터 리스트</a>
              </li>

              <li>
                <a href="input_data.php"><i class="fa fa-fw fa-table"></i> 데이터 등록 페이지</a>
              </li>
              <li>
                <a href="change_order_data.php"><i class="fa fa-fw fa-table"></i> 데이터 순서 변경</a>
              </li> -->
              <!--<li>
